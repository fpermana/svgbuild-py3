...
def main():
	...
	parser.add_argument('--object-color', default='#FFFFFF', help='object color')
	...
	parser.add_argument('--full-path', default=False, action='store_true', help='create path point by point')
	parser.add_argument('--fill-path', default=False, action='store_true', help='fill color object while build point by point')
